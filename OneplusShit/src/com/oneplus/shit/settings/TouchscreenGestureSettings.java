...
public class TouchscreenGestureSettings extends PreferenceActivity
    ...
    public static class MainSettingsFragment extends PreferenceFragment {
        ...
        private static void sendUpdateBroadcast(final Context context,
                final TouchscreenGesture[] gestures) {
            final Intent intent = new Intent(ButtonConstants.UPDATE_PREFS_ACTION);
            ...
            intent.putExtra(ButtonConstants.UPDATE_EXTRA_KEYCODE_MAPPING, keycodes);
            intent.putExtra(ButtonConstants.UPDATE_EXTRA_ACTION_MAPPING, actions);
