...
public class TouchKeyHandler implements DeviceKeyHandler {
    ...
    private final BroadcastReceiver mUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            int[] keycodes = intent.getIntArrayExtra(
                    ButtonConstants.UPDATE_EXTRA_KEYCODE_MAPPING);
            int[] actions = intent.getIntArrayExtra(
                    ButtonConstants.UPDATE_EXTRA_ACTION_MAPPING);
    ...
    public TouchKeyHandler(final Context context) {
        ...
        mContext.registerReceiver(mUpdateReceiver,
                new IntentFilter(ButtonConstants.UPDATE_PREFS_ACTION));
    }
    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(final Message msg) {
            switch (msg.arg1) {
                case ButtonConstants.ACTION_CAMERA:
                    launchCamera();
                    break;
                case ButtonConstants.ACTION_FLASHLIGHT:
                    toggleFlashlight();
                    break;
                case ButtonConstants.ACTION_BROWSER:
                    launchBrowser();
                    break;
                case ButtonConstants.ACTION_DIALER:
                    launchDialer();
                    break;
                case ButtonConstants.ACTION_EMAIL:
                    launchEmail();
                    break;
                case ButtonConstants.ACTION_MESSAGES:
                    launchMessages();
                    break;
                case ButtonConstants.ACTION_PLAY_PAUSE_MUSIC:
                    playPauseMusic();
                    break;
                case ButtonConstants.ACTION_PREVIOUS_TRACK:
                    previousTrack();
                    break;
                case ButtonConstants.ACTION_NEXT_TRACK:
                    nextTrack();
                    break;
                case ButtonConstants.ACTION_VOLUME_DOWN:
                    volumeDown();
                    break;
                case ButtonConstants.ACTION_VOLUME_UP:
                    volumeUp();
                    break;
            }
        }
